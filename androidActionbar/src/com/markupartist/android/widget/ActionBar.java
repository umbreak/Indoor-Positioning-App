...
//    private ImageView mUpdateImage;
    ...
    public ActionBar(Context context, AttributeSet attrs) {
        ...
        mHomeBtn = (ImageButton) mBarView.findViewById(R.id.btn_title_refresh);
    ...
    public void setProgressBarVisibility(int visibility) {
        ...
        if (visibility == View.GONE) mHomeBtn.setVisibility(View.VISIBLE);
        else mHomeBtn.setVisibility(View.GONE);
    }
    ...
    public void addAction(Action action, boolean clickable) {
        final int index = mActionsView.getChildCount();
        addAction(action, index, clickable);
    }
     ...
     */
    public void addAction(Action action, int index, boolean clickable) {
    	View child = inflateAction(action);
    	child.setEnabled(clickable);
        mActionsView.addView(child, index);
